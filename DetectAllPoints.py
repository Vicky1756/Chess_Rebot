...
if __name__ == "__main__":
    dir=os.listdir('/Users/Vicky/Desktop/chessboard/raw_dataset')
    print(dir)
    count_error=0
    error=[]
    for name in dir :
        file = f'/Users/Vicky/Desktop/chessboard/raw_dataset/{name}'
        try:
            print(name)
            img = cv2.imread(file)
    # print(bytearray(img))
            ...
            cv2.imwrite(f"/Users/Vicky/Desktop/chessboard/result/{name}",W)
        except:
            print(f"error_{name}")
            error.append(name)
            count_error+=1
    dir2=os.listdir('/Users/Vicky/Desktop/chessboard/result')
    # dir2=["18_510.jpg"]
    count_crop=29774
    count_eror2=0
    for name in dir2 :
        file = f'/Users/Vicky/Desktop/chessboard/result/{name}'
        try:
            print(name)
            img = cv2.imread(file)
    # print(bytearray(img))
            ...
            for i in range(8):
                for j in range(8):
                    try:
                        ...
                        cv2.imwrite(f'/Users/Vicky/Desktop/chessboard/chess_crop/All_data/{img_name}', cropped__img)
